...
public:
    ...
    void delNode(int num){
        ...
        // rewireNode(successor_Node->parent, successor_Node->right, 1);
        ...
        // rewireNode(successor_Node, deletion_Node->)
    }
...
int main(){
    ...
    while (true){
        ...
        if (command == "add"){
            ...
            tree.rewireNode(tree.root, left, 0);
            tree.rewireNode(tree.root, right, 1);

            tree.rewireNode(left, left_child, 0);
            tree.rewireNode(right, right_child, 1);
        }
